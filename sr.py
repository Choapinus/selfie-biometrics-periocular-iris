...
args.flags.DEFINE_string("folder_images", "data/mobbio", "Target folder")
FLAGS = args.get()
...
def main(_):
	...
	img_list = sorted(list(list_images(FLAGS.folder_images)))
	
	for imdir in img_list:
		model.do_for_file(imdir, FLAGS.output_dir)
